    ...
    <div class="page-wrapper">
        <div class="top">
            <el-form :inline="true" class="demo-form-inline">
                ...
                <el-form-item v-show="areaCategory === 'M' && areaPower === 2" class="form-item-select" label="设备所在地">
                    <el-row>
                        <el-select
                            style="width: 142px"
                            v-model="provinceValue"
                ...
                <el-form-item v-show="areaCategory === 'M' && areaPower === 3" class="form-item-select" label="设备所在地">
                    <el-row>
                        <el-select
                            style="width: 142px"
                            v-model="provinceValue"
                ...
                <el-form-item class="form-item-btn one">
                    <el-button class="btn" type="primary" @click="querySubmit" size="medium">搜索</el-button>
            ...
            <div class="tab-top">
                ...
                <el-button class="btn" @click="exportExcel" type="success" size="medium">导出</el-button>
            </div>
